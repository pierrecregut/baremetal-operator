...
func (in *BareMetalHostSpec) DeepCopyInto(out *BareMetalHostSpec) {
	*out = *in
	...
	if in.ConsumerOverride != nil {
		in, out := &in.ConsumerOverride, &out.ConsumerOverride
		*out = new(ConsumerOverride)
		(*in).DeepCopyInto(*out)
	}
	if in.Image != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConsumerOverride) DeepCopyInto(out *ConsumerOverride) {
	*out = *in
	if in.AutomatedCleaningMode != nil {
		in, out := &in.AutomatedCleaningMode, &out.AutomatedCleaningMode
		*out = new(AutomatedCleaningMode)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConsumerOverride.
func (in *ConsumerOverride) DeepCopy() *ConsumerOverride {
	if in == nil {
		return nil
	}
	out := new(ConsumerOverride)
...
func (in *ProvisionStatus) DeepCopyInto(out *ProvisionStatus) {
	*out = *in
	if in.OverriddenCleaningPerformed != nil {
		in, out := &in.OverriddenCleaningPerformed, &out.OverriddenCleaningPerformed
		*out = new(AutomatedCleaningMode)
		**out = **in
	}
